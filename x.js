(function () {
    ...
    const templatesSimple = [
        ...
        "加密市场低迷？不如来蓝V互关！留言就能获50+关注，有关必回，永不取关。l.pingoo.trade #蓝V互关",
        "大V秘诀：前期互关抱团！蓝V朋友评论区集合，我100%回关，一起破局。m.pingoo.trade #蓝V互关",
        "持续蓝V互关中，优先活跃账号。看到关注就回，没看到评论提醒。互相成就！n.pingoo.trade #蓝V互关",
        "蓝V互关走起！评论“滴滴”收获蓝V粉丝，诚信秒回，一起玩转X。o.pingoo.trade #蓝V互关",
        "人脉就是财富，蓝V互关来一波。有关必回，打造优质圈子，一起前行。p.pingoo.trade #蓝V互关",
        "蓝V集结！互关支持，评论留言获互推机会。真实互动，拒绝套路。q.pingoo.trade #蓝V互关",
        "周末蓝V互关时间！留言你将有30蓝V好友，秒关秒回，一起互动。r.pingoo.trade #蓝V互关",
        "Web3玩家蓝V互关，分享项目经验。评论互关，互相学习成长。s.pingoo.trade #蓝V互关",
        "蓝V互关，100%诚信回关。优先有输出账号，一起提升权重。t.pingoo.trade #蓝V互关",
        "来蓝V互关，评论“支持”获即时回关。互相点赞转发，玩转算法。u.pingoo.trade #蓝V互关",
        "蓝V朋友们，互关一波！永不取关，有关必回，一起追逐机会。v.pingoo.trade #蓝V互关",
        "加密搭子蓝V互关，避坑分享。留言互关，构建网络。w.pingoo.trade #蓝V互关",
        "蓝V互关集结号！评论区滴滴，我秒回，一起涨粉丝。x.pingoo.trade #蓝V互关",
        "优先互关蓝V活跃号，看到回关。互相支持，成就彼此。y.pingoo.trade #蓝V互关",
        "蓝V互关，评论获蓝V关注。诚信第一，一起抱团。z.pingoo.trade #蓝V互关",
        "新一周蓝V互关！留言“互关”收获惊喜，秒回不鸽。l.pingoo.trade #蓝V互关",
        "蓝V互关，分享生活感悟。有关必回，一起正能量。m.pingoo.trade #蓝V互关",
        "蓝V小圈子互关，优先Web3账号。评论提醒，回关支持。n.pingoo.trade #蓝V互关",
        "蓝V互关走一波！100%回关，互相成长不孤单。o.pingoo.trade #蓝V互关",
        "蓝V互关，评论“来啦”获互推。真实互动，拒绝单关。p.pingoo.trade #蓝V互关",
        "持续蓝V互关中，有关必回。一起玩成真社交！q.pingoo.trade #蓝V互关",
        "蓝V朋友互关，永不取关。留言集合，一起前行。r.pingoo.trade #蓝V互关",
        "蓝V互关，优先有内容账号。秒回支持，互相成就。s.pingoo.trade #蓝V互关",
        "来波蓝V互关！评论获40+关注，诚信互惠。t.pingoo.trade #蓝V互关",
        "蓝V互关集结，分享创业经验。留言互关，一起破圈。u.pingoo.trade #蓝V互关",
        "蓝V互关，100%秒回。互相点赞，转发助力。v.pingoo.trade #蓝V互关",
        "周四蓝V互关时间！评论“互关”收获粉丝。w.pingoo.trade #蓝V互关",
        "蓝V互关，构建Web3网络。有关必回，一起探索。x.pingoo.trade #蓝V互关",
        "蓝V互关走起！优先活跃蓝V，互相支持。y.pingoo.trade #蓝V互关",
        "蓝V互关，评论提醒回关。诚信第一，长期合作。z.pingoo.trade #蓝V互关",
        "蓝V朋友们互关一波！永不取关，一起涨粉。l.pingoo.trade #蓝V互关",
        "蓝V互关，分享币圈机会。留言互关，避雷同行。m.pingoo.trade #蓝V互关",
        "持续蓝V互关，看到就回。互相成就，玩转X。n.pingoo.trade #蓝V互关",
        "蓝V互关集结！评论“滴滴”秒获回关。o.pingoo.trade #蓝V互关",
        "蓝V互关，优先真实账号。一起点赞转发。p.pingoo.trade #蓝V互关",
        "新蓝V互关！留言获互惠，诚信秒回。q.pingoo.trade #蓝V互关",
        "蓝V互关，生活正能量分享。有关必回。r.pingoo.trade #蓝V互关",
        "蓝V小伙伴互关，Web3项目讨论。评论集合。s.pingoo.trade #蓝V互关",
        "蓝V互关，100%回关率。一起抱团成长。t.pingoo.trade #蓝V互关",
        "蓝V互关，评论“支持”获蓝V好友。互相互动。u.pingoo.trade #蓝V互关",
        "蓝V互关走一波！永不取关，互相前行。v.pingoo.trade #蓝V互关",
        "加密蓝V互关，机会分享。留言互关。w.pingoo.trade #蓝V互关",
        "蓝V互关，优先有输出蓝V。秒回支持。x.pingoo.trade #蓝V互关",
        "来蓝V互关！评论获惊喜粉丝，诚信互惠。y.pingoo.trade #蓝V互关",
        "蓝V互关集结号，创业者集合。互相成就。z.pingoo.trade #蓝V互关",
        "蓝V互关，100%秒关。点赞转发助力。l.pingoo.trade #蓝V互关",
        "周末蓝V互关！评论“互关”收获多。m.pingoo.trade #蓝V互关",
        "蓝V互关，探索Web3。有关必回，一起学习。n.pingoo.trade #蓝V互关",
        "蓝V互关结束一周！优先活跃，互相支持成长。o.pingoo.trade #蓝V互关"
    ];

    // 预设回复模板 (Preset reply templates) - 内容版 (Content/Detailed)
    const templatesDetailed = [
        "上周花了三天研究一个DeFi项目，把数据整理成图表发出来。没想到几位关注很久的蓝V都来评论了，我们在评论区聊了很多坑和机会。如果你也在研究Web3项目，欢迎来聊聊你的看法。#Web3Trends l.pingoo.trade #蓝V互关",
        "这轮行情让不少人又开始焦虑了。我昨天整理了一些数据和自己的判断发出来，收到很多共鸣。市场不好的时候，交流避坑经验比预测涨跌更有用。做交易的朋友可以聊聊。#CryptoMarket m.pingoo.trade #蓝V互关",
        "最近在测试AI工具在业务流程中的应用，效果超出预期。把完整的案例拆解发出来后，不少创业的朋友来交流他们的实践。创业路上确实需要多交流，少走弯路。#StartupTips n.pingoo.trade #蓝V互关",
        "前几天采访了一位行业前辈，聊了很多关于商业增长的话题。整理成对话形式发出来，评论区的讨论比我预想的还热烈。做业务的朋友应该会有共鸣。#BusinessGrowth o.pingoo.trade #蓝V互关",
        "试了一个月的新工作方法，效率提升了不少。配了些数据和照片分享出来，发现很多人也在探索类似的生活方式。关于时间管理和效率提升，我们可以多聊聊。#DigitalLife p.pingoo.trade #蓝V互关",
        "整理了2026年上半年的几个科技趋势，配了一些前瞻性的分析。发出来后不少技术背景的朋友来讨论，角度都很独特。关注科技创新的可以交流下看法。#TechInnovation q.pingoo.trade #蓝V互关",
        "去年那波下跌时的操作复盘了一遍，发现几个明显的决策失误。把这些经验教训写出来，没想到很多人都遇到过类似的坑。加密交易确实需要不断总结。#CryptoRecovery r.pingoo.trade #蓝V互关",
        "最近在整理收藏，顺便写了些产区和品鉴的笔记。发现不少蓝V朋友也喜欢这个，大家在评论区分享了很多有意思的故事。玩雪茄的朋友可以交流一下。#LuxuryLifestyle s.pingoo.trade #蓝V互关",
        "在交易上试了一个新的方法，市场反馈还不错。把具体的操作步骤和心得分享出来，收到不少老师朋友的反馈和补充。做交易的应该能理解这种成就感。#Trading t.pingoo.trade #蓝V互关",
        "参与了几个Web3项目后，对这个领域有了更深的理解。把踩过的坑和收获整理成帖子，不少在做项目的朋友来交流。Web3还在早期，多交流总没错。#Web3Projects u.pingoo.trade #蓝V互关",
        "创业三年，从亏损到盈利的过程挺不容易的。分享了一些关键转折点的决策，评论区很多创业者都有类似经历。这条路确实需要互相鼓励。#MotivationMonday v.pingoo.trade #蓝V互关",
        "最近读完一本商业类书籍，写了篇深度书评。没想到引发了不少讨论，大家推荐的书单也很有价值。爱读书的朋友可以交换一下书单。#BookLovers w.pingoo.trade #蓝V互关",
        "差点踩了一个大坑，幸好及时发现了项目的几个风险点。把完整的分析过程发出来，希望能帮其他人避雷。做投资的都懂风控有多重要。#BlockchainSecurity x.pingoo.trade #蓝V互关",
        "对2026年下半年的加密市场做了个趋势分析，配了几张图表。发出来后不少人来讨论，也认识了一些做相关领域的朋友。如果你也在关注市场动向，欢迎聊聊。y.pingoo.trade #蓝V互关",
        "最近对工作和生活的平衡有了新的理解，写了些感悟发出来。没想到引起了很多共鸣，大家分享的经验也很有启发。保持活力确实需要找到自己的节奏。z.pingoo.trade #蓝V互关",
        "在X上互关了大半年，遇到过取关的，但更多是长期互动的朋友。分享了一些维护关系的心得，其实就是真诚对待。做长期主义的朋友应该懂这个道理。l.pingoo.trade #蓝V互关",
        "每周一都会制定这周的目标和计划，这个习惯坚持了一年多。把方法论分享出来后，不少人表示也想试试。一起做计划管理的可以互相监督。m.pingoo.trade #蓝V互关",
        "生活中的一些小确幸记录下来发出去，发现其实很多人需要这种正能量。我们互相鼓励，日子会过得更有劲。喜欢分享生活的朋友可以多交流。n.pingoo.trade #蓝V互关",
        "观察了几个Web3社区的运营方式，写了些思考和建议。做社区的朋友来讨论了很多实操问题，收获挺大。Web3的社区文化确实独特。#NFTTrends o.pingoo.trade #蓝V互关",
        "这半年认识了不少志同道合的朋友，大家互相支持成长。把这段经历写出来，想告诉大家抱团确实比单打独斗好。一起成长的感觉很棒。p.pingoo.trade #蓝V互关",
        "尝试了几次和其他博主的互推合作，效果还不错。分享了一些合作的注意事项，希望对想尝试的人有帮助。互推的核心还是价值互换。q.pingoo.trade #蓝V互关",
        "在X上待久了发现，真正有意思的连接都来自真诚互动，不是套路式互关。分享你感兴趣的内容，和志同道合的人聊天，关系自然就建立了。做内容的朋友应该懂这个感觉。r.pingoo.trade #蓝V互关",
        "互关容易，长期维护关系才难。分享了一些我保持长期互动的方法，其实就是把对方当真正的朋友。那些一直没取关的，基本都成了真朋友。#FriendshipGoals s.pingoo.trade #蓝V互关",
        "坚持高质量输出半年多了，粉丝质量明显提升。分享了一些内容创作的思路和方法，做内容的朋友应该能理解持续输出的不易。我们可以互相学习。t.pingoo.trade #蓝V互关",
        "有几次因为内容被大V转发，涨粉速度超出预期。把这些经验总结出来分享，其实核心就是内容要真的有价值。做内容的都期待这种惊喜时刻。u.pingoo.trade #蓝V互关",
        "做了个创业话题的系列分享，吸引了不少创业者来交流。我们建了个小群互相支持，氛围挺好的。如果你也在创业路上，欢迎加入讨论。#Entrepreneurship v.pingoo.trade #蓝V互关",
        "试了一段时间快速回复评论，发现互动效果确实好很多。分享了一些提高响应速度的方法，愿意投入时间做互动的朋友可以试试。w.pingoo.trade #蓝V互关",
        "每周都会回顾这周的进展，调整下周计划。把这个习惯分享出来后，不少人表示也想试试。我们可以互相分享周复盘的心得。#WeekendVibes x.pingoo.trade #蓝V互关",
        "最近在深入研究DeFi协议，把学习笔记整理成系列发出来。收到很多同样在学习的朋友的反馈，大家一起探索这个领域。学习DeFi的可以交流。#DeFi y.pingoo.trade #蓝V互关",
        "保持账号活跃度需要一些方法，分享了我的实践心得。其实就是真诚参与讨论，而不是为了互动而互动。愿意投入时间运营账号的可以聊聊。z.pingoo.trade #蓝V互关",
        "遇到过互关后就取关的，也遇到过一直保持互动的真朋友。分享了一些判断对方是否靠谱的小技巧，诚信互关才能长久。l.pingoo.trade #蓝V互关",
        "账号从几百粉到几千粉的过程，总结了一些实用的涨粉方法。最重要的还是内容质量和持续输出。想认真做账号的可以交流下心得。m.pingoo.trade #蓝V互关",
        "最近在研究几个山寨币项目，把分析过程记录下来。不少做币圈投资的朋友来交流观点，大家一起研究总能发现更多机会。#Altcoins n.pingoo.trade #蓝V互关",
        "在X上持续输出内容一年多了，分享一些坚持下来的心得。其实就是找到自己的节奏，不要为了发帖而发帖。做长期运营的应该有共鸣。o.pingoo.trade #蓝V互关",
        "观察了一些热门话题的传播规律，总结了参与讨论的一些技巧。及时参与优质话题确实能提高曝光。会玩X的朋友可以交流下玩法。p.pingoo.trade #蓝V互关",
        "发现真实账号比僵尸粉账号的互动质量高太多。分享了一些识别真实账号的方法，互关还是要找真正做内容的人。q.pingoo.trade #蓝V互关",
        "作为过来人，给新蓝V一些互关的建议。其实就是先做好内容，再考虑互关。内容是基础，关系是结果。新入局的可以少走弯路。r.pingoo.trade #蓝V互关",
        "坚持分享正能量内容，收获了一群志同道合的朋友。发现正能量确实会吸引正能量的人。喜欢传播积极内容的可以互相关注。#Wellness s.pingoo.trade #蓝V互关",
        "组织了几次Web3项目的深度讨论，参与的都是真正在做事的人。这种高质量的交流很难得，欢迎对Web3认真的朋友加入。#Metaverse t.pingoo.trade #蓝V互关",
        "测试了不同的互关方式，发现真诚的互动回关率最高。分享了一些提高回关率的实践，其实核心就是展现你的价值。u.pingoo.trade #蓝V互关",
        "在X上建立了自己的支持网络，大家互相点赞评论。这种互助的感觉很好，让做内容不再孤单。愿意互相支持的朋友可以加入。v.pingoo.trade #蓝V互关",
        "互关容易，长期维护才是考验。分享了一些我保持长期关系的方法，就是把每个互关都当作真正的朋友对待。w.pingoo.trade #蓝V互关",
        "最近在研究Bitcoin的链上数据，发现了一些有意思的规律。把分析过程分享出来，欢迎做Bitcoin研究的朋友来讨论。#Bitcoin x.pingoo.trade #蓝V互关",
        "坚持优质内容输出，发现粉丝质量越来越高。分享了一些内容创作的思路，做内容的朋友应该能理解持续输出的价值。y.pingoo.trade #蓝V互关",
        "通过互关认识了很多优秀的人，收获超出预期。分享了一些互关带来的意外收获，真诚互关确实能带来惊喜。z.pingoo.trade #蓝V互关",
        "建了个创业者的小社群，大家定期分享进展和困难。这种互助的氛围很棒，欢迎认真创业的朋友加入。#Innovation l.pingoo.trade #蓝V互关",
        "和几个朋友建立了互助点赞的机制，大家的内容曝光都提升了。这种互相支持的方式很有效，愿意参与的可以加入。m.pingoo.trade #蓝V互关",
        "每周末都会复盘这周的运营情况，分享了一些复盘的方法 and 心得。做账号运营的应该都需要定期复盘。#WeekendVibes n.pingoo.trade #蓝V互关",
        "最近在研究Metaverse相关的项目，把学习笔记整理出来。对Web3和元宇宙感兴趣的朋友可以一起探索这个领域。#Metaverse o.pingoo.trade #蓝V互关",
        "总结了这段时间的互关经验，最大的收获是认识了很多真诚的朋友。互关的意义不只是数字增长，更是关系的建立。p.pingoo.trade #蓝V互关"
    ];
    ...
    const createOrUpdateLabel = (container, status, isUserCell) => {
        if (isUserCell) {
            ...
            let bgColor = '';
            let borderColor = '';
            // 提高透明度以增强可见性 (Increase alpha for better visibility)
            if (status === 'mutual') {
            ...
            // 变更前检查以减少 Mutation 触发 (Check before change to reduce Mutation triggers)
            if (container.style.backgroundColor !== bgColor) {
                container.style.backgroundColor = bgColor;
            }
            const borderStyle = borderColor ? `4px solid ${borderColor}` : 'none';
            if (container.style.borderLeft !== borderStyle) {
                container.style.borderLeft = borderStyle;
            }
            return;
        }
